...
class cardParser extends Listener {
    ...
    constructor (private element: HTMLInputElement, private typeElement: HTMLInputElement) {
        super(element);
        this.accepted = false;
    }
    ...
    private checkSupported(cardNumber: string) {
        const acceptedCards: any = {           // HAD TO PUT any BECAUSE I COULDNT GET AWAY WITH AN REGEXP ERROR ODWN IN Object.keys
            visa: /^4[0-9]{12}(?:[0-9]{3})?$/,
